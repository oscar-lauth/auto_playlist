...
def create_playlist(name:str,description:str="Playlist auto-generated by Oscar Lauth",is_public:bool=False)->dict:
    ...
    res_dict = response.json()
    user.p_id = res_dict["id"] # should playlist_id be stored in User or stored in frontend and passed as path param in generate playlist?
    return res_dict
